...
try {
    $pdo_mjwifi = new PDO("mysql:host=$host;dbname=$dbname;charset=utf8mb4", $username, $password);
    $pdo_mjwifi->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
...
// Function to get total withdrawals for MJWiFi
...
// Fetch sales data for MJWiFi site
...
// Fetch logs from mjwifi database
$stmt = $pdo_mjwifi->prepare("
    SELECT 
        id,
        external_ref,
        msisdn,
...
// Get sales data for MJWiFi
$salesData = getSalesDataBySite($pdo_mjwifi, 'mjwifi');

// Get withdrawal data for MJWiFi user
$totalWithdrawals = getTotalWithdrawals($withdrawDb, 'MJWiFi');
...
<head>
    ...
    <title>MJWiFi Sales Dashboard</title>
        ...
        <div class="max-w-7xl mx-auto px-6 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">MJWiFi - Yo Payments</h1>
    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="mb-8">
            ...
            <div class="bg-gradient-to-br from-blue-600 to-cyan-600 rounded-xl shadow-lg p-8 text-white">
                <div class="flex justify-between items-start mb-6">
                    <div>
                        <h3 class="text-2xl font-semibold opacity-90">MJWiFi</h3>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-cyan-600">
                ...
                <p class="text-sm text-white/90 mt-1">Latest transactions for MJWiFi (All Statuses)</p>
            </div>
