<?php
header('Location: https://payments.onlustech.com/');
exit;
...
try {
    $pdo_guma = new PDO("mysql:host=$host;dbname=$dbname;charset=utf8mb4", $username, $password);
    $pdo_guma->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
...
// Function to get total withdrawals for Guma
...
// Fetch sales data for Guma site
...
// Fetch logs from guma_mikrotik database
$stmt = $pdo_guma->prepare("
    SELECT 
        id,
        external_ref,
        msisdn,
...
// Get sales data for Guma
$salesData = getSalesDataBySite($pdo_guma, 'guma');

// Get withdrawal data for Guma user
$totalWithdrawals = getTotalWithdrawals($withdrawDb, 'Guma-Omada');
...
<head>
    ...
    <title>Guma Sales Dashboard</title>
        ...
        <div class="max-w-7xl mx-auto px-6 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">guma - Yo Payments</h1>
    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="mb-8">
            ...
            <div class="bg-gradient-to-br from-purple-600 to-pink-600 rounded-xl shadow-lg p-8 text-white">
                <div class="flex justify-between items-start mb-6">
                    <div>
                        <h3 class="text-2xl font-semibold opacity-90">guma</h3>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-purple-600 to-pink-600">
                ...
                <p class="text-sm text-white/90 mt-1">Latest transactions for guma (All Statuses)</p>
            </div>
