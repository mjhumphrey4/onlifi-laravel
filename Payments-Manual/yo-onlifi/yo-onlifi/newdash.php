    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            foreach ($sites as $site): 
                ...
                $balance = $totalAmount - $totalWithdrawals - $charge;
            ?>
            <div class="<?php echo $colors[$site]; ?> rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-transform">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-2">UGX <?php echo number_format($totalAmount - $charge, 2); ?></p>
                        <p class="text-sm opacity-80 mt-1">Total Revenue (Successful Vouchers Only)</p>
                    </div>
