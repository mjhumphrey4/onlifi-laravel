...
const features = [
  { icon: Router, title: 'Mikrotik Ready', text: 'Provision hotspot, RADIUS, captive files, telemetry, and SSTP from one script.' },
      ...
      <section className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 grid lg:grid-cols-[1.05fr_0.95fr] gap-10 items-center px-6 lg:px-12 py-12">
          <div className="max-w-3xl">
            <p className="text-cyan-300 font-semibold mb-4">ZERO Nonsense Network Management System</p>
            ...
            <p className="text-lg text-slate-300 mt-6 max-w-2xl">
              ONLIFI gives operators the practical tools they need: site isolation, MikroTik provisioning, RADIUS vouchers, captive pages, mobile money payments, and router monitoring.
            </p>
          ...
          <div className="rounded-xl border border-white/10 bg-slate-900 p-5 shadow-2xl">
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              <div>
                <p className="text-sm text-slate-400">Production Snapshot</p>
            ...
            <div className="mt-5 rounded-lg bg-emerald-500/10 border border-emerald-400/20 p-4">
              <div className="flex items-center gap-2 text-emerald-300 font-semibold">
                ...
                Built for operators, not brochures
              </div>
              <p className="text-sm text-slate-300 mt-2">No fluff. Just the controls needed to keep clients online, paid, and visible.</p>
            </div>
          </div>
        </div>
      </section>
