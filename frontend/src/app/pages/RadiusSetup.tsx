        ...
        <div className="space-y-6">
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            <div className="flex items-start gap-2 mb-4">
              ...
              <p className="text-sm text-muted-foreground">Run the one-line command on the MikroTik terminal. It downloads and immediately imports the setup script, then configures LAN, DHCP, NAT, hotspot, RADIUS, WireGuard VPN, captive files, and telemetry for this site.</p>
            </div>
