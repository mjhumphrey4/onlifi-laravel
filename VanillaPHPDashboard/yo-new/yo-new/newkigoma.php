...
$host = 'localhost';
$dbname = 'kigoma'; // Changed from 'guma_mikrotik' to 'kigoma'
$username = 'yo';
$password = 'password';

try {
    $pdo_kigoma = new PDO("mysql:host=$host;dbname=$dbname;charset=utf8mb4", $username, $password);
    $pdo_kigoma->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
...
// Function to get total withdrawals for Kigoma
...
// Fetch sales data for Kigoma site
...
// Fetch logs from kigoma database
$stmt = $pdo_kigoma->prepare("
    SELECT 
        id,
        external_ref,
        msisdn,
        ...
        voucher_code
    FROM transactions 
    WHERE origin_site = 'BITE TECH NETWORK'
    $sql_condition
...
// Get sales data for BITE TECH NETWORK
$salesData = getSalesDataBySite($pdo_kigoma, 'BITE TECH NETWORK');

// Get withdrawal data for Kigoma user
...
<head>
    ...
    <title>Kigoma Sales Dashboard</title>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-6 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">BITE TECH NETWORK - Yo Payments</h1>
                        <p class="text-blue-100">Real-time Voucher Sales Monitor</p>
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="mb-8">
            ...
            ?>
            <div class="bg-gradient-to-br from-blue-600 to-cyan-600 rounded-xl shadow-lg p-8 text-white">
                <div class="flex justify-between items-start mb-6">
                    <div>
                        <h3 class="text-2xl font-semibold opacity-90">BITE TECH NETWORK</h3>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-cyan-600">
                <h2 class="text-xl font-bold text-white">Recent Payment Logs</h2>
                <p class="text-sm text-white/90 mt-1">Latest transactions for BITE TECH NETWORK (All Statuses)</p>
            </div>
