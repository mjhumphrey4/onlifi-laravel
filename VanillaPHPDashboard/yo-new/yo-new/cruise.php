...
try {
    $pdo_cruise = new PDO("mysql:host=$host;dbname=$dbname;charset=utf8mb4", $username, $password);
    $pdo_cruise->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
...
// Function to get total withdrawals for Cruise
...
// Fetch sales data for Cruise site
...
// Fetch logs from cruise database
$stmt = $pdo_cruise->prepare("
    SELECT 
        id,
        external_ref,
        msisdn,
...
// Get sales data for Cruise
$salesData = getSalesDataBySite($pdo_cruise, 'cruise');

// Get withdrawal data for Cruise user
$totalWithdrawals = getTotalWithdrawals($withdrawDb, 'Cruise');
...
<head>
    ...
    <title>Cruise Sales Dashboard</title>
        ...
        <div class="max-w-7xl mx-auto px-6 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">Cruise - Yo Payments</h1>
                        <p class="text-indigo-100">Real-time Voucher Sales Monitor</p>
                    </div>
                </div>
                <div class="flex items-center gap-4">
                    ...
                    <div class="text-right">
                        ...
                        <div class="text-indigo-100"><?php echo date('h:i:s A'); ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="mb-8">
            ...
            <div class="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-xl shadow-lg p-8 text-white">
                <div class="flex justify-between items-start mb-6">
                    <div>
                        <h3 class="text-2xl font-semibold opacity-90">Cruise</h3>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-indigo-600 to-purple-600">
                ...
                <p class="text-sm text-white/90 mt-1">Latest transactions for Cruise (All Statuses)</p>
            </div>
            ...
            <div class="px-6 py-4 border-t border-gray-200 bg-gray-50 text-center">
                <a href="?last_log_time=<?php echo urlencode($last_log_time_for_next); ?>" class="px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-indigo-600 rounded-md hover:bg-indigo-700 transition-colors inline-block">
                    Next Logs &rarr;
                </a>
            </div>
