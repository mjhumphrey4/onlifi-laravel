            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border">
                  {['ID', 'Voucher', 'Phone', 'Reference', 'Amount', 'Telecom Fee', 'Net Amount', 'Site', 'Status', 'Date'].map((h) => (
              ...
              <tbody>
                {loading ? (
                  <tr><td colSpan={10} className="py-10 text-center"><RefreshCw className="w-5 h-5 text-primary animate-spin mx-auto" /></td></tr>
                ) : txs.length === 0 ? (
                  <tr><td colSpan={10} className="py-8 text-center text-muted-foreground text-sm">No transactions found.</td></tr>
                ) : txs.map((tx, i) => {
