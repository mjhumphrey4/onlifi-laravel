...
HTML;
    ...
    private function renderManualLoginTemplate(string $template, array $config): string
    {
        ...
        $legacyReplacements = [
            ...
            'Powered by Onlus Technologies' => 'Powered by ONLIFI NMS - www.onlifi.net',
            'Powered by Onluf Technologies' => 'Powered by ONLIFI NMS - www.onlifi.net',
            'Powered by Onluf Technlogies' => 'Powered by ONLIFI NMS - www.onlifi.net',
            'Powered by STK WIFI POINT' => 'Powered by ONLIFI NMS - www.onlifi.net',
